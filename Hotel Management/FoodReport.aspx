<%@ Page Title="" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="FoodReport.aspx.cs" Inherits="Hotel_Management.FoodReport" %>
                        ...
                        <div class="panel-body">
                            <asp:GridView runat="server" ID="gvGeneralReport" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Amount" HeaderText="Amount" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center" />
                                    ...
                                    <asp:BoundField DataField="InvoiceValue" HeaderText="Invoice Value" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Center" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
