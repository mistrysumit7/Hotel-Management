<%@ Page Title="General Report - Apple Residency" Language="C#" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" CodeBehind="GeneralReport.aspx.cs" Inherits="Hotel_Management.GeneralReport" %>
        ...
        <ContentTemplate>
            <div class="row" style="width:100%; font-size:12.5px;">
                <div class="col-lg-12">
                        ...
                        <asp:GridView runat="server" ID="gvGeneralReport" AutoGenerateColumns="false" CssClass="table table-responsive table-striped table-bordered table-hover">
                            <Columns>
                                <asp:BoundField DataField="BillNumber" HeaderText="Bill Number" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="BillingDate" HeaderText="Billing Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="CheckInDate" HeaderText="Check-In Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                <asp:BoundField DataField="CheckOutDate" HeaderText="Check-Out Date" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                

                                <asp:BoundField DataField="CustomerName" HeaderText="Customer Name" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="Room_No" HeaderText="Room No" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left" />
...
<%--                                <asp:BoundField DataField="CustomerAddress" HeaderText="Customer Address" HeaderStyle-HorizontalAlign="Left" />--%>
                                <asp:BoundField DataField="Age" HeaderText="Age" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="Nationality" HeaderText="Nationality" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="ProfName" HeaderText="Prof Name" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="CustomerProofNumer" HeaderText="Customer Proof Number" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="CustomerArrival" HeaderText="Arrival From" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="CustomerDeparture" HeaderText="Depature From" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="MobileNo" HeaderText="Mobile No." HeaderStyle-HorizontalAlign="Left" />
                                <%--  <asp:BoundField DataField="BookedFrom" HeaderText="Booked From" HeaderStyle-HorizontalAlign="Left" />
                                <asp:BoundField DataField="BookedTo" HeaderText="Booked To" HeaderStyle-HorizontalAlign="Left" />--%>
                            </Columns>
                        </asp:GridView>
